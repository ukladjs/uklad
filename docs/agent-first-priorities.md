...
| `appState` -> `state` at public boundaries                    | **P1**                                                 | **M**                      | **High**                                   | **Conditional**                 | Common model vocabulary reduces token/context friction; aliases allow a staged migration.                                                               |
...
| ----------------------- | ----------------------------------------------------- | ------------------------- | ----------------- | --------------- |
| `AppState`, `appState`        | `AppState`, `state`                                   | **M**                     | **High**          | **Conditional** |
