...
- `@ukladjs/core@0.2.0` — instance-owned runtime, typed contracts, React and vanilla bindings, reactive subscriptions, effects/coeffects, testing helpers, and inspector APIs.
