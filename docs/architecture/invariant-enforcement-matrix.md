...
| `EV-03` | State snapshots and root or computed subscription results are exposed as readonly runtime-owned values.          | `I`, `A`      | `T`, `S`                               | `none`          | Public type tests and focused mutation-contract tests.                                          |
