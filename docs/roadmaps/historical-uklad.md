...
> **Superseded (July 2026)** by the phased [Reflex roadmap](reflex.md). Kept for reference: the **agent indexing model** remains valid, and open items here have been folded into the new roadmap's phases.
