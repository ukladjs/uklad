...
| `appDb` -> `state` at public boundaries                    | **P1**                                                 | **M**                      | **High**                                   | **Conditional**                 | Common model vocabulary reduces token/context friction; aliases allow a staged migration.                                                               |
| `draftDb` -> `draft`                                       | **P1**                                                 | **M**                      | **High**                                   | **Conditional**                 | Both properties can coexist temporarily, but removing `draftDb` breaks handlers.                                                                        |
...
| ----------------------- | ----------------------------------------------------- | ------------------------- | ----------------- | --------------- |
| `AppDb`, `appDb`        | `AppState`, `state`                                   | **M**                     | **High**          | **Conditional** |
| `initialDb`             | `initialState`                                        | **S**                     | **Medium**        | **Conditional** |
| `getAppDb()`            | `getState()`                                          | **S**                     | **Medium**        | **Conditional** |
| `restoreAppDb()`        | `replaceState()` or fixture-specific `restoreState()` | **M**                     | **High**          | **Conditional** |
| `draftDb`               | `draft`                                               | **M**                     | **High**          | **Conditional** |
